...
points is nearly aligned with the blue horizontal dashed line with
y-intercept = 0. This means our residuals values “bounce” around 0,
suggesting that the assumption that the relationship between predictors
and outcome is linear is reasonable. <br><br>
...
The 95% Confidence Interval of *r̂*<sup>2</sup> is (0.89, 0.93).
...
also looks like having a normal distribution.
